...
- Numbered folders 3-5 are still on net8.0 / AvnRepository 8.0.1. When upgrading them, use AvnRepository 10.0.2 + Newtonsoft.Json 13.0.4 (10.0.1 was a broken dotnet-tool publish).

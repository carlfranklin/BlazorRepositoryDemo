...
- Numbered folder 5 is still on net8.0 / AvnRepository 8.0.1. When upgrading it, use AvnRepository 10.0.2 + Newtonsoft.Json 13.0.4 (10.0.1 was a broken dotnet-tool publish).
